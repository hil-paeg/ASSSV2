...
//   // Dummy data for 4 months overview
//   const ticketOverviewData = {
//     '2024-04-02': { type: 'ticket_raised', title: 'Server Downtime Reported' },
//     '2024-04-05': { type: 'site_visit', title: 'Server Room Inspection' },
//     '2024-04-10': { type: 'ticket_raised', title: 'Network Latency Issue' },
//     '2024-04-12': { type: 'site_visit', title: 'Router Maintenance' },
//     '2024-04-18': { type: 'ticket_raised', title: 'Application Crash' },
//     '2024-04-22': { type: 'site_visit', title: 'Cooling System Check' },
//     '2024-04-28': { type: 'ticket_raised', title: 'Security Breach Alert' },
//     '2024-05-03': { type: 'site_visit', title: 'Hardware Upgrade' },
//     '2024-05-07': { type: 'ticket_raised', title: 'Database Connection Error' },
//     '2024-05-09': { type: 'ticket_raised', title: 'API Timeout Issue' },
//     '2024-05-15': { type: 'site_visit', title: 'Network Audit' },
//     '2024-05-20': { type: 'ticket_raised', title: 'Software Bug Reported' },
//     '2024-05-25': { type: 'site_visit', title: 'Equipment Calibration' },
//     '2024-06-02': { type: 'ticket_raised', title: 'Login Failure' },
//     '2024-06-08': { type: 'site_visit', title: 'Firewall Maintenance' },
//     '2024-06-12': { type: 'ticket_raised', title: 'Performance Degradation' },
//     '2024-06-17': { type: 'site_visit', title: 'Data Center Visit' },
//     '2024-06-23': { type: 'ticket_raised', title: 'Backup Failure'  },
//     '2024-06-29': { type: 'site_visit', title: 'System Health Check' },
//     '2024-07-04': { type: 'ticket_raised', title: 'Application Error' },
//     '2024-07-10': { type: 'site_visit', title: 'Infrastructure Review' },
//     '2024-07-14': { type: 'ticket_raised', title: 'Authentication Issue' },
//     '2024-07-19': { type: 'site_visit', title: 'Server Maintenance' },
//     '2024-07-25': { type: 'ticket_raised', title: 'Network Congestion' },
//     '2024-07-30': { type: 'site_visit', title: 'Security System Check' },
//   };

//   // Dummy data for monthly view
//   const calendarEvents = {
//     '2024-07-02': { type: 'ticket_raised', title: 'Server Overload Issue' },
//     '2024-07-04': { type: 'site_visit', title: 'Site Inspection Scheduled' },
//     '2024-07-07': { type: 'ticket_raised', title: 'Database Query Failure' },
//     '2024-07-09': { type: 'site_visit', title: 'Hardware Maintenance' },
//     '2024-07-12': { type: 'ticket_raised', title: 'Network Connectivity Issue' },
//     '2024-07-15': { type: 'site_visit', title: 'System Upgrade Visit' },
//     '2024-07-18': { type: 'ticket_raised', title: 'Software Crash Reported' },
//     '2024-07-20': { type: 'site_visit', title: 'Cooling System Audit' },
//     '2024-07-23': { type: 'ticket_raised', title: 'Security Patch Required' },
//     '2024-07-26': { type: 'site_visit', title: 'Network Infrastructure Check' },
//     '2024-07-28': { type: 'ticket_raised', title: 'API Integration Error' },
//     '2024-07-30': { type: 'site_visit', title: 'Backup System Review' },
//   };
...
//           {days.map((day, index) => {
//             if (!day) return <div key={index} className="h-24 border-r border-b last:border-r-0 bg-gray-50/30"></div>;
...
//                     <div className="h-24 border-r border-b last:border-r-0 p-2 relative hover:bg-gray-50/50 transition-colors">
//                       <div className={`text-sm font-medium w-8 h-8 rounded-full flex items-center justify-center ring-2 ring-transparent ${
//                         isToday ? 'bg-blue-600 text-white ring-blue-300' : 
//                         event?.type === 'ticket_raised' ? 'bg-red-500 text-white ring-red-300' :
//                         event?.type === 'site_visit' ? 'bg-pink-500 text-white ring-pink-300' :
//                         'text-gray-900 hover:ring-gray-200'
//                       }`}>
//                         {day}
//                       </div>
//                     </div>
...
//                         {event.type === 'ticket_raised' ? 'Ticket Raised' : 'Site Visit'}
//                       </p>
//                     </TooltipContent>
//                   )}
//                 </Tooltip>
...
//             </SelectTrigger>
//             <SelectContent>
//               <SelectItem value="overview">Tickets Overview</SelectItem>
...
//             <h4 className="text-lg font-medium text-gray-700 mb-4">Past 4 Months Summary</h4>
//             <div className="grid grid-cols-4 gap-6">
//               {[0, 1, 2, 3].map(offset => {
//                 const month = (selectedMonth - offset + 12) % 12;
//                 const year = selectedYear - (offset > selectedMonth ? 1 : 0);
//                 return (
...
//                 <span className="text-sm text-gray-600">Site Visit Planned</span>
//               </div>
//             </div>
//           </div>
//         ) : (
